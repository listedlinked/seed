...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "itis-seeder\n"
...
static const string mainnet_seeds[] = {"dns.itis.network", ""};
static const string testnet_seeds[] = {"dns.itis.network", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 60202), true);
  }
  do {
